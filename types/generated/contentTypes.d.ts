...
export interface ApiAiToolAiTool extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    available_at_KI_Lab: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    developers: Schema.Attribute.String;
    githubLink: Schema.Attribute.String;
    googleCollabLink: Schema.Attribute.String;
    internalInfo: Schema.Attribute.RichText;
    localAppLink: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ai-tool.ai-tool'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    softwareLink: Schema.Attribute.String;
    toolImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    toolName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    toolTags: Schema.Attribute.Relation<'manyToMany', 'api::tool-tag.tool-tag'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    webToolLink: Schema.Attribute.String;
  };
}
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    include_day: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    include_time: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFestivalsPageFestivalsPage extends Struct.SingleTypeSchema {
  collectionName: 'festivals_pages';
  info: {
    displayName: 'Festivals Page';
...
export interface ApiFilmPageFilmPage extends Struct.SingleTypeSchema {
  collectionName: 'film_pages';
  info: {
    displayName: 'Film Page';
    pluralName: 'film-pages';
    singularName: 'film-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiKiFilmeKiFilme extends Struct.CollectionTypeSchema {
  collectionName: 'ki_filmes';
  info: {
    description: '';
    displayName: 'KI Filme';
    pluralName: 'ki-filmes';
    singularName: 'ki-filme';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    filmmaker: Schema.Attribute.String;
    filmtitle: Schema.Attribute.String & Schema.Attribute.Required;
    HFFproject: Schema.Attribute.Boolean;
    length: Schema.Attribute.Integer;
    link: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ki-filme.ki-filme'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiKiMedienprojektKiMedienprojekt
  extends Struct.CollectionTypeSchema {
  collectionName: 'ki_medienprojekts';
  info: {
    description: '';
    displayName: 'KI Medienprojekt';
    pluralName: 'ki-medienprojekts';
    singularName: 'ki-medienprojekt';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    artists: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ki-medienprojekt.ki-medienprojekt'
    > &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videoLink: Schema.Attribute.String;
    videoLink2: Schema.Attribute.String;
  };
}

export interface ApiMedienprojektePageMedienprojektePage
  extends Struct.SingleTypeSchema {
  collectionName: 'medienprojekte_pages';
  info: {
    displayName: 'Medienprojekte Page';
    pluralName: 'medienprojekte-pages';
    singularName: 'medienprojekte-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::medienprojekte-page.medienprojekte-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiNewsCarouselNewsCarousel extends Struct.SingleTypeSchema {
  collectionName: 'news_carousels';
  info: {
    displayName: 'News Carousel';
    pluralName: 'news-carousels';
    singularName: 'news-carousel';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::news-carousel.news-carousel'
    > &
      Schema.Attribute.Private;
...
export interface ApiToolTagToolTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aiTools: Schema.Attribute.Relation<'manyToMany', 'api::ai-tool.ai-tool'>;
...
export interface ApiTutorialGroupTutorialGroup
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tutorial-group.tutorial-group'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTutorialPageTutorialPage extends Struct.SingleTypeSchema {
  collectionName: 'tutorial_pages';
  info: {
    displayName: 'Tutorial Page';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tutorial_groups: Schema.Attribute.Relation<
      'oneToMany',
      'api::tutorial-group.tutorial-group'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTutorialTutorial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    embedLink: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'https://www.youtube.com/embed/q7Uk-cD8gG4'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    tutorial_group: Schema.Attribute.Relation<
      'manyToOne',
      'api::tutorial-group.tutorial-group'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiUeberUnsUeberUns extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    our_team: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::film-page.film-page': ApiFilmPageFilmPage;
      'api::ki-filme.ki-filme': ApiKiFilmeKiFilme;
      'api::ki-medienprojekt.ki-medienprojekt': ApiKiMedienprojektKiMedienprojekt;
